            ...
            <div className={classes["top-footer"]}>
                ...
                <div className={classes["more-info"]}>
                    ...
                    <div className={classes["footer-info"]}>
                        <Link className={classes.a} href="">Мій профіль</Link>
                        <Link className={classes.a} href="contact.html">Контакти</Link>
                        <Link className={classes.a} href="about-us.html">Про нас</Link>
                    </div>
                </div>
            </div>
