...
import { confirmDeletionClose, confirmDeletionOk } from '@boilerplate/front-end/store/sagas/confirm-deletion.saga'
import { confirmDeletionSlice } from '@boilerplate/front-end/store/slices/confirm-deletion.slice'
          ...
          >
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <button
                ...
                className="inline-flex w-full justify-center rounded-md border border-transparent bg-[#ff5959] px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-[#ff2929] focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
