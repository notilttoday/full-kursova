    ...
    <div className={classes['our-contacts']}>
      <div className={classes['contact-box']}>
        ...
        <div className={classes['contact-info']}>
          <Link className={classes.a} href="tel: +380681239812">
            +380 (68) 123-98-12
          </Link>
          <Link className={classes.a} href="tel: +380689873421">
            +380 (68) 987-34-21
          </Link>
        </div>
      </div>
      <div className={classes['contact-box']}>
        ...
        <div className={classes['contact-info']}>
          <Link className={classes.a} href="mailto:figures-shop@gmail.com">
            figures-shop@gmail.com
          </Link>
          <Link className={classes.a} href="mailto:figures-shop@ukr.net">
            figures-shop@ukr.net
          </Link>
        </div>
      </div>
    </div>
