...
export class CreateMessageTable1730144995990 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "contact_message" ADD CONSTRAINT "FK_9a9251f3d3d40dda2161c1488d9" FOREIGN KEY ("profileId") REFERENCES "profile"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
