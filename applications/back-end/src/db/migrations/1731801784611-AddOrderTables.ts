...
export class AddOrderTables1731801784611 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userGid" uuid, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`,
    )
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_deb7c17b2fc953289e132d0376" ON "order_to_product" ("orderId", "productId") `,
    )
    await queryRunner.query(
      `ALTER TABLE "order_to_product" ADD CONSTRAINT "FK_3e918511a5f968387c92e33d62c" FOREIGN KEY ("orderId") REFERENCES "order"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "order_to_product" ADD CONSTRAINT "FK_860f23d5d0ea5583e57344e9071" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }
